local thing = {'WE COULD NOT MAKE IT', 'IF ONLY WE HAD ENOUGH TIME', 'THIS ISNT WORTH THE RISK', 'WELCOME TO LIMBO', 'TRAPPED', 'BURNED ALIVE', 'ASHES TO ASHES', 'ITS OVER', 'NOTHING LEFT', 'PURGATORY'}
