...
idleOffsets = {'89', '1'}        -- I recommend you have your idle offset at 0
leftOffsets = {'89', '2'}
downOffsets = {'89', '1'}
upOffsets = {'89', '1'}
rightOffsets = {'89', '2'}
...
function onCreate()
    ...
    addAnimationByPrefix(name_of_character, 'jonah', jonah_xml_name, 24, false);
