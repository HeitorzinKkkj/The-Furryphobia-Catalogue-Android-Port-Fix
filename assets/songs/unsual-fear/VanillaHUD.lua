...
vanillaHealthcolors = false -- if you want the health colors to be the same as vanilla (red to dad, aka the one on the left; green to bf, aka the on the right).
...
function onCreatePost()
	...
	makeLuaText('proto', 'unfinished song yet', 300, 0, 0)
